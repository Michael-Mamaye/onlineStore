            ...
            <div className={Mike?classes.wholeNav2:classes.wholeNav}>
                <div className={classes.appBar}>
                    ...
                    <div className={classes.searchBar}>
                        <input className="textfields"placeholder="you can search for items here"></input>
                        <span className="searchIcon"><Search/></span>
                    </div>
                    
                    <div className={`shopingCart ${classes.shopings}`}>
                       <Link className={classes.loginLink} to='/login'><Button style={{color:'#83420C'}}variant='outlined'>Log In</Button></Link>
                        <ShoppingBasket style={{height:'30px',width:'30px',color:'#83420C'}}></ShoppingBasket>
